        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="p-8 space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-gray-500">Entre para gerir as suas viagens e saldo</p>
            </div>

            <div className="space-y-4">
              <Button variant="outline" className="w-full gap-2 h-11 font-medium bg-transparent" type="button">
            ...
            <div className="text-center text-sm text-gray-500">
              Não tem conta?{" "}
              <Link href={`/${params.lang}/register`} className="text-primary font-medium hover:underline">
                Registar agora
              </Link>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 text-center text-xs text-gray-500 border-t border-gray-100">
            Ao entrar, aceita os nossos Termos e Condições e Política de Privacidade.
          </div>
        </div>
      </main>
    </div>
